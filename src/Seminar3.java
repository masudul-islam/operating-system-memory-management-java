public class Seminar3 {
	...
	private static final String BACKING_STORE_FILE = "/Users/i.m.masudul/IdeaProjects/Seminar3/BACKING_STORE.bin";
	private static final String ADDRESSES_FILE = "/Users/i.m.masudul/IdeaProjects/Seminar3/addresses.txt";
	...
	public static boolean shortOutput = false;
	...
	private static void testTaskOne()
	{
		...
		MemoryManager memoryManager = new MemoryManager(NUMBER_OF_PAGES, PAGE_SIZE, NUMBER_OF_FRAMES_256, BACKING_STORE_FILE, NO_PAGE_REPLACEMENT, shortOutput);
	...
	private static void verifyFifo(int numberOfPageFaults, int expectedPageFaults, int numberOfFrames)
	{
		...
		assert numberOfPageFaults == expectedPageFaults;
	...
	{
		MemoryManager memoryManager = new MemoryManager(NUMBER_OF_PAGES, PAGE_SIZE, numberOfFrames, BACKING_STORE_FILE, FIFO_PAGE_REPLACEMENT, shortOutput);
		MemoryProcess mp = new MemoryProcess(ADDRESSES_FILE, memoryManager);
		mp.callMemory();
	...
	{
		MemoryManager memoryManager = new MemoryManager(NUMBER_OF_PAGES, PAGE_SIZE, numberOfFrames, BACKING_STORE_FILE, LRU_PAGE_REPLACEMENT, shortOutput);
		MemoryProcess mp = new MemoryProcess(ADDRESSES_FILE, memoryManager);
		mp.callMemory();
